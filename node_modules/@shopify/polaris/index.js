...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.27.0';
}

var polarisVersion = '4.27.0';
...
var COLORS_WITH_BACKDROPS = ['blueDark', 'teal', 'tealDark', 'greenDark', 'redDark', 'yellowDark', 'ink', 'inkLighter'];
function Icon(_ref) {
...
var PopoverOverlay = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function PopoverOverlay() {
    ...
    _this.contentNode = /*#__PURE__*/React.createRef(); // eslint-disable-next-line @shopify/react-no-multiple-render-methods
      ...
      _this.renderActions = function () {
        ...
        var actionMarkup = overriddenActions.map(function (action, index) {
          ...
          var content = action.content,
              ...
              rest = tslib.__rest(action, ["content", "onAction"]);
...
function ComboBox(_ref) {
  ...
  var activatePopover = React.useCallback(function () {
...
function () {
  var CollapsibleInner = /*#__PURE__*/function (_React$Component) {
    ...
    function CollapsibleInner() {
      ...
      _this.heightNode = /*#__PURE__*/React.createRef();
...
var Day = /*#__PURE__*/React.memo(function Day(_ref) {
  var day = _ref.day,
      focused = _ref.focused,
      onClick = _ref.onClick,
...
var Weekday = /*#__PURE__*/React.memo(function Weekday(_ref) {
  var label = _ref.label,
      title = _ref.title,
...
var emptySearch = 'data:image/svg+xml;base64,';
...
var Focus = /*#__PURE__*/React.memo(function Focus(_ref) {
  var children = _ref.children,
      disabled = _ref.disabled,
      root = _ref.root;
  React.useEffect(function () {
...
function () {
  var FiltersInner = /*#__PURE__*/function (_React$Component) {
    ...
    function FiltersInner() {
      ...
      _this.moreFiltersButtonContainer = /*#__PURE__*/React.createRef();
...
var FormLayout = /*#__PURE__*/React.memo(function FormLayout(_ref) {
  var children = _ref.children;
  return /*#__PURE__*/React__default.createElement("div", {
...
var ToastManager = /*#__PURE__*/React.memo(function ToastManager(_ref) {
...
function () {
  var FrameInner = /*#__PURE__*/function (_React$PureComponent) {
    ...
    function FrameInner() {
      ...
      _this.navigationNode = /*#__PURE__*/React.createRef();
...
var TooltipOverlay = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    _this = _super.apply(this, arguments); // eslint-disable-next-line @shopify/react-no-multiple-render-methods
...
var BulkActionsInner = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function BulkActionsInner() {
    ...
    _this.checkableWrapperNode = /*#__PURE__*/React.createRef();
    _this.largeScreenGroupNode = /*#__PURE__*/React.createRef();
    _this.smallScreenGroupNode = /*#__PURE__*/React.createRef();
...
var DateSelector = /*#__PURE__*/React.memo(function DateSelector(_ref) {
...
var ResourceList = function ResourceList(_ref) {
  var items = _ref.items,
      ...
      resourceNameProp = _ref.resourceName,
      promotedBulkActions = _ref.promotedBulkActions,
      ...
      alternateTool = _ref.alternateTool,
      onSortChange = _ref.onSortChange,
      onSelectionChange = _ref.onSelectionChange,
      renderItem = _ref.renderItem,
      _ref$idForItem = _ref.idForItem,
      idForItem = _ref$idForItem === void 0 ? defaultIdForItem : _ref$idForItem,
      resolveItemId = _ref.resolveItemId;
  var i18n = useI18n();

  var _useState = React.useState(Boolean(selectedItems && selectedItems.length > 0)),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var _useState7 = React.useState(isSmallScreen()),
      _useState8 = _slicedToArray(_useState7, 2),
  ...
  var _useState9 = React.useState(new Map()),
      _useState10 = _slicedToArray(_useState9, 2),
      checkableButtons = _useState10[0],
      setCheckableButtons = _useState10[1];

  var defaultResourceName = useLazyRef(function () {
    return {
      singular: i18n.translate('Polaris.ResourceList.defaultItemSingular'),
      plural: i18n.translate('Polaris.ResourceList.defaultItemPlural')
    };
  ...
  var setLoadingPosition = React.useCallback(function () {
  ...
  var headerMarkup = !showEmptyState && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && /*#__PURE__*/React__default.createElement("div", {
...
var TabMeasurer = /*#__PURE__*/React.memo(function TabMeasurer(_ref) {
...
var TopBar = function TopBar(_ref) {
  ...
  var _useToggle = useToggle(false),
      focused = _useToggle.value,
      forceTrueFocused = _useToggle.setTrue,
      forceFalseFocused = _useToggle.setFalse; // eslint-disable-next-line react-hooks/exhaustive-deps
