...
export const MediaQueryProvider = function MediaQueryProvider({ children, }) {
    ...
    }, 40, { trailing: true, leading: true, maxWait: 40 }), [isNavigationCollapsed]);
    useEffect(() => {
        setIsNavigationCollapsed(navigationBarCollapsed().matches);
    }, []);
    return (<MediaQueryContext.Provider value={{ isNavigationCollapsed }}>
